...
('4', 'UPN "Veteran" Jawa Timur','Teknik Informatika', '2018 - Now'),
('3', 'SMA Al-Irsyad Surabaya','IPA', '2015 - 2018'),
('2', 'SMP Negeri 15 Surabaya','', '2012 - 2015'),
('1', 'SDN Sidotopo Wetan IV/558','', '2006 - 2012');
...
('1','Ms.Office','(word, excel, ppt)','90%'),
('2','Pemrograman Web','','70%'),
('3','Desain UI/UX','','70%');